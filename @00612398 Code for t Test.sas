...
DATE: Sunday, 9 January 2022     TIME: 1:47:09 am
PROJECT: Project
...
/*   START OF NODE: t Test (3)   */
%LET _CLIENTTASKLABEL='t Test (3)';
...
/* -------------------------------------------------------------------
   ...
   Generated on: Saturday, January 8, 2022 at 12:40:34 AM
   By task: t Test (3)
...
PROC SQL;
	CREATE VIEW WORK.TMP0TempTableInput AS
		SELECT T.Continent, T."Population growth (annual %)"n
...
PROC TTEST 
	...
	CLASS Continent;
	VAR "Population growth (annual %)"n;
RUN;
